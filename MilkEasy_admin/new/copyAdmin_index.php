    ...
    <div class="">
        ...
        <div id="Aboutus" class="bg-gray-300 sm:mt-2 w-full">
            ...
            <div class="flex flex-col sm:flex-row mb-3">
                ...
                <div class="mx-4 pt-3 py-9">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque neque rerum numquam molestiae
                        dolor
                        officia culpa ipsa fuga, reiciendis dolorem ipsum quasi ipsam dicta necessitatibus aperiam?
                        Nisi,
                        suscipit ducimus molestiae necessitatibus expedita tempora! Quod voluptatibus maxime doloribus
        ...
        <form action="">
            <div class=" flex flex-col bg-gray-300">
                ...
                <input type="text" placeholder="First name" class="outline outline-1 m-3 pl-2 " onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123 || event.charCode==32)" required>
                <input type="text" placeholder="Last name" class="outline outline-1 m-3 pl-2"  onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123 || event.charCode==32)" required>
                <textarea placeholder="Message" cols="3" rows="3" class="outline outline-1 m-3 pl-2"
                    required></textarea>
                <input type="submit" value="Submit"
                    class="outline outline-1 mb-3 mx-[40%] rounded-full bg-green-300 hover:bg-green-400 active:bg-green-500">

...
if (isset($_SESSION['loggedinn'])) {
  ...
  $query = mysqli_query($conn, "select * from admin_registration where name='$id'");
...
<body>
  ...
  <nav class="float-left w-full p-4 bg-black shadow md:justify-between fixed mt-0">
    ...
    <ul
      ...
      <li class="mx-4 my-4 md:my-0">
        <a href="#Home" class="text-l text-cyan-500 "> <?php echo 'Hi  '. $row['name']; ?></a>
      </li>
      <li class="mx-4 my-4 md:my-0">
  ...
  <div class="dropdown absolute right-0">
    ...
    <div id="myDropdown" class="dropdown-content mt-14 float-right z-10">
      ...
      <a href="view_payment.php" class="hover:bg-gray-300">View Farmer Payments </a>
      <a href="view_coll_payment.php" class="hover:bg-gray-300">View collector Payments </a>

...
if (isset($_POST['submit'])) {
  ...
  $select = mysqli_query($conn, "SELECT * FROM milkcollector_registration WHERE id = '$id' AND password = '$password'") or die('query failed');
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="collector_Login.php" method="post">

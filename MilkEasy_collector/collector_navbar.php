...
<body>
  ...
  <div class="dropdown absolute right-0">
    ...
    <div id="myDropdown" class="dropdown-content mt-14 float-right z-10">
      <a href="collector_prfile.php" class="hover:bg-gray-300">View Profile</a>
      <a href="View_collection.php" class="hover:bg-gray-300">View collection</a>
      <a href="collection_form.php" class="hover:bg-gray-300">Add collection</a>
      <a href="collector_logout.php" class="hover:bg-gray-300">Logout</a>
    </div>
  </div>

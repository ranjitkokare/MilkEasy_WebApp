...
if (isset($_SESSION['loggedinn'])) {
  ...
  $query = mysqli_query($conn, "select * from farmer_registration where name='$id'");
...
<script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
  ...
  <nav class="float-left w-full p-4 bg-black shadow md:justify-between fixed mt-0">
    ...
    <ul
      class="mt-0 text-white md:flex z-[-1] md:static absolute bg-gray-500 md:bg-black w-full left-0 md:w-auto md:py-0 md:pl-0 pl-7 md:opacity-100 opacity-0 top[-400]">
      <li class="mx-4 my-4 md:my-0">
        <a href="" class="text-l text-cyan-500 "> <?php echo 'Hi  '. $row['name']; ?></a>
      </li>
      <li class="mx-4 my-4 md:my-0">
        <a href="#Home" class="text-l hover:text-cyan-500 ">Home</a>
      </li>
      <li class="mx-4 my-4 md:my-0">
  ...
  <div class="dropdown absolute right-0">
    ...
    if (isset( $_SESSION['loggedinn'])) {
      ...
      <?php
        ...
        ?>
        <a href="../newlogin.php" class="dropbtn text-white hover:text-cyan-500">Login</a>
        <?php
      }
      ?>
    ...
    <div id="myDropdown" class="dropdown-content mt-14 float-right z-10">
      <a href="Farmer_prfile.php" class="hover:bg-gray-300">View Profile</a>
      <a href="view_Collection.php" class="hover:bg-gray-300">View collection</a>
      <a href="payment.php" class="hover:bg-gray-300">View payment</a>
      <a href="Logout.php" class="hover:bg-gray-300">Logout</a>
    </div>
  </div>
